...
export const metadata: Metadata = {
  title: "Privacy Policy - Porta-Kamp",
  description: "Porta-Kamp privacy policy. Learn how we collect, use, and protect your personal information.",
};
    ...
    <div className="legal-page">
      ...
      <section className="legal-content">
        <div className="legal-inner">
          <h2>Who we are</h2>
          <p>Our website address is: www.portakamp.com</p>
          ...
          <p>
            ...
            available here: <a href="https://automattic.com/privacy/" target="_blank" rel="noopener noreferrer">https://automattic.com/privacy/</a>.
